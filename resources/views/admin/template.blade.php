...
<head>
    <meta charset="utf-8" />
    <title>Sohel | Commited to better services</title>
    ...
    <link href="{{asset('admin/css/bootstrap-switch.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{asset('admin/css/default.min.css')}}" rel="stylesheet" type="text/css" id="style_color" />
...
<script src="{{asset('admin/js/morris.min.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="{{asset('admin/js/app.min.js')}}" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="{{asset('admin/js/dashboard.min.js')}}" type="text/javascript"></script>
...
<script src="{{asset('admin/js/quick-sidebar.min.js')}}" type="text/javascript"></script>
<script src="{{asset('admin/js/quick-nav.min.js')}}" type="text/javascript')}}"></script>
<script src="{{asset('admin/js/custom.js')}}" type="text/javascript"></script>
<script src="{{asset('Admin/js.js')}}" type="text/javascript"></script>
